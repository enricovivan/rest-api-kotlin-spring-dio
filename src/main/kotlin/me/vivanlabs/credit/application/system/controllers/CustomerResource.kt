...
import me.vivanlabs.credit.application.system.dtos.CustomerDto
import me.vivanlabs.credit.application.system.dtos.CustomerUpdateDto
import me.vivanlabs.credit.application.system.dtos.CustomerView
import me.vivanlabs.credit.application.system.model.Customer
import me.vivanlabs.credit.application.system.services.impl.CustomerService
...
class CustomerResource (
    ...
    fun saveCustomer(@RequestBody customerDto: CustomerDto): ResponseEntity<String> {
        ...
        val message = "Customer ${savedCustomer.firstName} ${savedCustomer.lastName} saved!!"
